...
export interface backendInterface {
    ...
    addVideo(title: string, description: string, youtubeVideoId: string): Promise<string>;
    ...
    updateVideo(id: string, title: string, description: string, youtubeVideoId: string): Promise<void>;
}
...
export class Backend implements backendInterface {
    ...
    async updateVideo(arg0: string, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
